...
td, a{
   ...
   include("data_class.php");
    ?>
           <div class="container">
            <div class="innerdiv">
            <div class="row"><img class="imglogo" src="images/m.png"/></div>
            ...
            <p style="color: rgb(0 123 255 / 50%);"><u>Person Name:</u> &nbsp&nbsp<?php echo $name ?></p>
            <p style="color: rgb(0 123 255 / 50%);"><u>Person Email:</u> &nbsp&nbsp<?php echo $email ?></p>
            <p style="color: rgb(0 123 255 / 50%);"><u>Account Type:</u> &nbsp&nbsp<?php echo $type ?></p>
